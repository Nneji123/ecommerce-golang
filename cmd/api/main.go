...
import (
	...
	_ "github.com/nneji123/ecommerce-golang/docs" // docs is generated by Swag CLI, you have to import it.
	...
	"github.com/nneji123/ecommerce-golang/auth"
	"github.com/nneji123/ecommerce-golang/config"
	"github.com/nneji123/ecommerce-golang/db"
	emailHandlers "github.com/nneji123/ecommerce-golang/internal/email"
	leadHandlers "github.com/nneji123/ecommerce-golang/internal/leads"
	"github.com/nneji123/ecommerce-golang/internal/middlewares"
	"log"
	"net/http"
	"os"
	"time"
...
//	@contact.name	LeadzAura Support
//	@contact.url	http://leadzaura.com
//	@contact.email	contact@leadzaura.com
...
func main() {
	...
	e.Use(auth.AuthorizeMiddleware(getOpenRoutes()))
	...
	// Leads routes
	leadHandlers.RegisterLeadHandlers(e)
	emailHandlers.RegisterEmailHandlers(e, client)
